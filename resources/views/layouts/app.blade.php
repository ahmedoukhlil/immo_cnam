                        ...
                        @if(auth()->check() && auth()->user()->canAccessTickets())
                            ...
                            <li>
                                <a href="{{ route('tickets.index') }}"
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('tickets.*') ? 'bg-indigo-700 text-white' : '' }}">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
