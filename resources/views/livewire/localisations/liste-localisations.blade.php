    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a 
                    href="{{ route('localisations.create') }}" wire:navigate
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a 
                                            href="{{ route('emplacements.index') }}?localisation={{ $localisation->idLocalisation }}" wire:navigate
                                        ...
                                        @if($isAdmin)
                                            <a 
                                                href="{{ route('localisations.edit', $localisation->idLocalisation) }}" wire:navigate
