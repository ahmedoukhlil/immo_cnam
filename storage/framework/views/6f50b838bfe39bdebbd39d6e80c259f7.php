<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white border border-indigo-200 rounded-lg shadow-sm p-6 mb-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-4"><?php echo e($editId ? 'Modifier la nature juridique' : 'Nouvelle nature juridique'); ?></h2>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $natures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 transition-colors <?php echo e(!$nature->actif ? 'opacity-60' : ''); ?>">
                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($nature->NatJur); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($nature->CodeNatJur ?? '—'); ?></td>
                    <td class="px-6 py-4 text-center">
                        <button wire:click="toggleActif(<?php echo e($nature->idNatJur); ?>)"
                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium transition-colors
                                <?php echo e($nature->actif ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'); ?>">
                            <span class="w-2 h-2 rounded-full mr-1.5 <?php echo e($nature->actif ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                            <?php echo e($nature->actif ? 'Actif' : 'Inactif'); ?>

                        </button>
                    </td>
                    <td class="px-6 py-4 text-right space-x-2">
                        <button wire:click="openEdit(<?php echo e($nature->idNatJur); ?>)"
                        ...
                        <button wire:click="delete(<?php echo e($nature->idNatJur); ?>)"
...
<?php /**PATH C:\xampp\htdocs\immos cnam\resources\views/livewire/parametres/liste-natures-juridiques.blade.php ENDPATH**/ ?>