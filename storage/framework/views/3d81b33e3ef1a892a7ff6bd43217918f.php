...
<head>
    ...
    <title><?php echo e(config('app.name', 'Immos CNAM')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        >
            ...
            <div class="flex items-center justify-between h-16 px-6 bg-indigo-900 border-b border-indigo-700">
                <div class="flex items-center space-x-2">
                    <img src="<?php echo e(asset('cnam-logo.jpg')); ?>" alt="CNAM" class="h-10 w-auto object-contain rounded">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3" x-data="{
                ...
                <ul class="space-y-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canManageInventaire()): ?>
                            ...
                            <li>
                                ...
                                <ul x-show="openMenu === 'immobilisations'" x-cloak x-transition class="mt-2 space-y-1 pl-4">
                                    <li>
                                        <a href="<?php echo e(route('biens.index')); ?>" wire:navigate
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('biens.transfert')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('biens.transfert.historique')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('biens.amortissements')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                            ...
                            <li>
                                ...
                                <ul x-show="openMenu === 'parametres'" x-cloak x-transition class="mt-2 space-y-1 pl-4">
                                    <li>
                                        <a href="<?php echo e(route('localisations.index')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('affectations.index')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('emplacements.index')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('designations.index')); ?>" wire:navigate
                                           class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                            ...
                            <!-- Inventaires -->
                            <li>
                                <a href="<?php echo e(route('inventaires.index')); ?>" wire:navigate
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                        ...
                        <?php if(auth()->check() && auth()->user()->canAccessTickets()): ?>
                            <?php
                                ...
                                <li>
                                    <button @click="toggle('tickets')"
                                        ...
                                        <div class="flex items-center gap-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbOuverts > 0): ?>
                                                <span class="bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($nbOuverts); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <ul x-show="openMenu === 'tickets'" x-cloak x-transition class="mt-2 space-y-1 pl-4">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('tickets.gestion')); ?>" wire:navigate
                                               class="flex items-center px-4 py-2 text-sm text-gray-400 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors"
                                ...
                                <li>
                                    <a href="<?php echo e(route('tickets.index')); ?>" wire:navigate
                                       ...
                                       :class="{ 'bg-indigo-700 text-white': isActive('/tickets') }">
                                        ...
                                        <span>Tickets</span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbOuverts > 0): ?>
                                            <span class="ml-auto bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($nbOuverts); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                </li>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="relative" x-data="{ open: false }" x-init="document.addEventListener('livewire:navigated', () => open = false)">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="hidden md:block text-left">
                                        ...
                                        <div class="text-xs text-gray-500">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($roleClass); ?>">
                            ...
                            <div 
                                ...
                                x-cloak
                            >
                                <a href="<?php echo e(route('profil')); ?>" wire:navigate class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mon profil</a>
                                <hr class="my-1">
...
<?php /**PATH C:\xampp\htdocs\immos cnam\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>