    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a 
                    href="<?php echo e(route('designations.create')); ?>" wire:navigate
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
                                            <a 
                                                href="<?php echo e(route('designations.edit', $designation)); ?>" wire:navigate
...
<?php /**PATH C:\xampp\htdocs\immos cnam\resources\views/livewire/designations/liste-designations.blade.php ENDPATH**/ ?>