<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isOccupant()): ?>
                Bienvenue, <span class="font-medium text-gray-700"><?php echo e(auth()->user()->nom ?: auth()->user()->users); ?></span>. Gérez vos tickets de maintenance.
            <?php elseif(auth()->user()->isTechnicien()): ?>
                Bienvenue, <span class="font-medium text-gray-700"><?php echo e(auth()->user()->nom ?: auth()->user()->users); ?></span>. Consultez vos tickets assignés.
            <?php else: ?>
    ...
    <?php if(auth()->user()->isOccupant() || auth()->user()->isTechnicien()): ?>
        <?php
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
            ...
            <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden">
                ...
                <p class="text-4xl font-extrabold text-orange-500"><?php echo e($nbOuverts); ?></p>
            ...
            <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden">
                ...
                <p class="text-4xl font-extrabold text-green-500"><?php echo e($nbFermes); ?></p>
            ...
            <div class="flex items-center justify-center bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl shadow-sm p-6">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('tickets.index')); ?>" wire:navigate
                       class="flex items-center gap-2 text-white font-semibold text-sm hover:opacity-90 transition">
                        Voir mes tickets
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mesTickets->isNotEmpty()): ?>
                <div class="divide-y divide-gray-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mesTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <a href="<?php echo e(route('tickets.show', $ticket)); ?>" wire:navigate
                           class="flex items-center justify-between px-6 py-3.5 hover:bg-gray-50 transition-colors">
                            <div class="min-w-0 flex-1">
                                <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($ticket->titre); ?></p>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($ticket->reference); ?> · <?php echo e($ticket->created_at?->diffForHumans()); ?></p>
                            </div>
                            <span class="ml-4 shrink-0 text-xs font-medium px-2.5 py-1 rounded-full <?php echo e($sc); ?>"><?php echo e($sl); ?></span>
                        </a>
    ...
    <?php if(auth()->user()->hasPermission('dashboard.stats_immobilisations') || auth()->user()->hasPermission('dashboard.stats_inventaire')): ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">

        <?php if(auth()->user()->hasPermission('dashboard.stats_immobilisations')): ?>
        ...
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden group hover:shadow-md transition-shadow">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-gray-900 mt-2"><?php echo e(number_format($totalBiens, 0, ',', ' ')); ?></p>
            ...
            <a href="<?php echo e(route('biens.index')); ?>" wire:navigate class="mt-4 inline-flex items-center text-xs text-blue-600 font-medium hover:text-blue-800 gap-1">
        ...
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden group hover:shadow-md transition-shadow">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-extrabold text-gray-900 mt-2"><?php echo e(number_format($totalLocalisations, 0, ',', ' ')); ?></p>
                    <p class="text-xs text-gray-500 mt-2"><?php echo e($nombreBatiments); ?> bâtiment(s)</p>
                </div>
            ...
            <a href="<?php echo e(route('localisations.index')); ?>" wire:navigate class="mt-4 inline-flex items-center text-xs text-emerald-600 font-medium hover:text-emerald-800 gap-1">
        ...
        <?php if(auth()->user()->hasPermission('dashboard.stats_inventaire')): ?>
        ...
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden group hover:shadow-md transition-shadow">
            ...
            <div class="flex items-start justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inventaireEnCours): ?>
                        <p class="text-lg font-bold text-gray-900 mt-2"><?php echo e($inventaireEnCours->annee); ?></p>
                        <div class="mt-1">
                            <?php
                            ...
                            ?>
                            <span class="text-xs font-medium px-2 py-0.5 rounded-full <?php echo e($badgeInv[0]); ?>"><?php echo e($badgeInv[1]); ?></span>
                        </div>
                        <div class="mt-3">
                            <div class="flex justify-between text-xs text-gray-500 mb-1">
                                <span>Progression</span>
                                <span class="font-semibold"><?php echo e(round($statistiquesInventaire['progression'] ?? 0, 1)); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-100 rounded-full h-1.5">
                                <div class="h-1.5 rounded-full transition-all duration-500
                                    <?php echo e(($statistiquesInventaire['progression'] ?? 0) >= 100 ? 'bg-green-500' :
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inventaireEnCours): ?>
                <a href="<?php echo e(route('inventaires.show', $inventaireEnCours->id)); ?>" wire:navigate class="mt-4 inline-flex items-center text-xs text-violet-600 font-medium hover:text-violet-800 gap-1">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-extrabold text-gray-900 mt-2 leading-tight">
                        <?php echo e(number_format($valeurTotale, 0, ',', ' ')); ?><span class="text-base font-semibold text-gray-500 ml-1">MRU</span>
                    </p>
    ...
    <?php if(auth()->user()->hasPermission('dashboard.stats_tickets') && !empty($statsTickets)): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('tickets.index')); ?>" wire:navigate class="text-xs font-medium text-indigo-600 hover:text-indigo-800 flex items-center gap-1">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            ...
            <div class="rounded-xl border <?php echo e($kpi['bg']); ?> <?php echo e($kpi['border']); ?> p-4 text-center">
                <p class="text-2xl font-extrabold <?php echo e($kpi['text']); ?>"><?php echo e($kpi['value']); ?></p>
                <p class="text-xs font-medium <?php echo e($kpi['sub']); ?> mt-1"><?php echo e($kpi['label']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $priorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $nb = $statsTickets['par_priorite'][$key] ?? 0; $pct = round($nb / $totalActifs * 100); ?>
                        <div class="flex items-center gap-3">
                            <span class="w-14 text-xs font-semibold <?php echo e($cfg['text']); ?>"><?php echo e($cfg['label']); ?></span>
                            <div class="flex-1 bg-gray-100 rounded-full h-2 overflow-hidden">
                                <div class="<?php echo e($cfg['bar']); ?> h-2 rounded-full transition-all duration-500" style="width: <?php echo e($pct); ?>%"></div>
                            </div>
                            <span class="w-5 text-xs font-bold text-gray-600 text-right"><?php echo e($nb); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p class="text-2xl font-extrabold text-gray-800"><?php echo e($statsTickets['ces_mois']); ?></p>
                </div>
                <div class="rounded-xl p-4 border <?php echo e($statsTickets['urgents_en_attente'] > 0 ? 'bg-red-50 border-red-100' : 'bg-gray-50 border-gray-100'); ?>">
                    <p class="text-xs <?php echo e($statsTickets['urgents_en_attente'] > 0 ? 'text-red-400' : 'text-gray-400'); ?> mb-1">Urgents non traités</p>
                    <p class="text-2xl font-extrabold <?php echo e($statsTickets['urgents_en_attente'] > 0 ? 'text-red-600' : 'text-gray-800'); ?>"><?php echo e($statsTickets['urgents_en_attente']); ?></p>
                </div>
                <div class="col-span-2 bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statsTickets['delai_moyen_h'] !== null): ?>
                        <?php
                            $h = $statsTickets['delai_moyen_h'];
                            $delaiLabel = $h < 24 ? round($h, 1).'h' : round($h / 24, 1).' jours';
                        ?>
                        <p class="text-2xl font-extrabold text-gray-800"><?php echo e($delaiLabel); ?></p>
                    <?php else: ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inventaireEnCours && auth()->user()->hasPermission('dashboard.stats_inventaire')): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        ...
        <div class="flex items-start justify-between mb-6">
            <div>
                <h3 class="text-sm font-semibold text-gray-800 flex items-center gap-2">
                    ...
                    ?>
                    <span class="text-xs font-medium px-2 py-0.5 rounded-full <?php echo e($badgeInv2); ?>"><?php echo e($labelInv2); ?></span>
                </h3>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6 pb-6 border-b border-gray-100">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statsInv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rounded-xl <?php echo e($si['bg']); ?> p-4 flex items-center gap-3">
                <div class="w-9 h-9 flex items-center justify-center bg-white/60 rounded-lg shrink-0">
                    <svg class="w-4.5 h-4.5 <?php echo e($si['icon_color']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:1.1rem;height:1.1rem">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="<?php echo e($si['svg']); ?>"/>
                    </svg>
                </div>
                <div>
                    <p class="text-xs font-medium text-gray-500"><?php echo e($si['label']); ?></p>
                    <p class="text-xl font-extrabold <?php echo e($si['text']); ?> leading-tight"><?php echo e($si['value']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $localisationsInventaire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/60 transition-colors">
                            <td class="px-5 py-3.5 font-medium text-gray-800"><?php echo e($loc['localisation']); ?></td>
                            <td class="px-5 py-3.5 text-center font-semibold text-gray-700"><?php echo e(number_format($loc['biens_attendus'], 0, ',', ' ')); ?></td>
                            <td class="px-5 py-3.5 text-center font-semibold <?php echo e($loc['biens_scannes'] > 0 ? 'text-blue-600' : 'text-gray-300'); ?>">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-20 bg-gray-100 rounded-full h-1.5 overflow-hidden">
                                        <div class="h-1.5 rounded-full transition-all duration-300
                                            <?php echo e($loc['progression'] >= 100 ? 'bg-green-500' : ($loc['progression'] >= 50 ? 'bg-blue-500' : ($loc['progression'] > 0 ? 'bg-yellow-400' : 'bg-gray-200'))); ?>"
                                            style="width: <?php echo e(min($loc['progression'], 100)); ?>%"></div>
                                    </div>
                                    <span class="text-xs font-semibold <?php echo e($loc['progression'] >= 100 ? 'text-green-600' : ($loc['progression'] > 0 ? 'text-gray-600' : 'text-gray-300')); ?>">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold rounded-full
                                    <?php echo e($loc['statut'] === 'termine'   ? 'bg-green-100 text-green-700' :
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loc['statut'] === 'en_attente'): ?> En attente
                                    <?php elseif($loc['statut'] === 'en_cours'): ?> En cours
                                    <?php elseif($loc['statut'] === 'termine'): ?> Terminé
                                    <?php else: ?> <?php echo e(ucfirst(str_replace('_', ' ', $loc['statut']))); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inventaireEnCours && in_array($inventaireEnCours->statut, ['en_preparation', 'en_cours'])): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inventaireEnCours && !empty($emplacementsInventories) && auth()->user()->hasPermission('dashboard.stats_inventaire')): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-sm font-semibold text-gray-800 flex items-center gap-2">
                ...
                <p class="text-xs text-gray-400 mt-1 ml-9"><?php echo e(count($emplacementsInventories)); ?> emplacement(s) avec des biens scannés</p>
            </div>
            <a href="<?php echo e(route('emplacements.index')); ?>" wire:navigate class="text-xs font-medium text-sky-600 hover:text-sky-800 flex items-center gap-1">
        ...
        <div class="overflow-x-auto rounded-xl border border-gray-100">
            <table class="min-w-full text-sm">
                ...
                <tbody class="bg-white divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/60 transition-colors">
                        <td class="px-5 py-3.5">
                            <p class="font-medium text-gray-800"><?php echo e($emplacement['nom']); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($emplacement['code'])): ?>
                                <p class="text-xs text-gray-400"><?php echo e($emplacement['code']); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-5 py-3.5 text-gray-600"><?php echo e($emplacement['localisation']); ?></td>
                        <td class="px-5 py-3.5 text-gray-600"><?php echo e($emplacement['affectation']); ?></td>
                        <td class="px-5 py-3.5 text-center">
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-2">
                                <div class="w-20 bg-gray-100 rounded-full h-1.5 overflow-hidden">
                                    <div class="h-1.5 rounded-full transition-all duration-300
                                        <?php echo e($emplacement['progression'] >= 100 ? 'bg-green-500' : ($emplacement['progression'] >= 50 ? 'bg-blue-500' : ($emplacement['progression'] > 0 ? 'bg-yellow-400' : 'bg-gray-200'))); ?>"
                                        style="width: <?php echo e(min($emplacement['progression'], 100)); ?>%"></div>
                                </div>
                                <span class="text-xs font-semibold <?php echo e($emplacement['progression'] >= 100 ? 'text-green-600' : ($emplacement['progression'] > 0 ? 'text-gray-600' : 'text-gray-300')); ?>">
    ...
    <?php if(auth()->user()->hasPermission('dashboard.activite_recente')): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        ...
        <div class="space-y-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dernieresActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="flex items-start gap-3 px-3 py-3 rounded-xl hover:bg-gray-50 transition-colors">
                    <div class="shrink-0 mt-0.5 w-7 h-7 flex items-center justify-center <?php echo e($actIcon['bg']); ?> rounded-lg">
                        <svg class="w-3.5 h-3.5 <?php echo e($actIcon['color']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="<?php echo e($actIcon['path']); ?>"/>
                        </svg>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-gray-700 leading-snug"><?php echo e($action['message']); ?></p>
                        <p class="text-xs text-gray-400 mt-0.5"><?php echo e($action['time_ago']); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if(auth()->user()->hasPermission('dashboard.actions_rapides')): ?>
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 class="text-sm font-semibold text-gray-800 mb-5">Actions rapides</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <a href="<?php echo e(route('biens.create')); ?>" wire:navigate
            ...
            <a href="<?php echo e(route('localisations.create')); ?>" wire:navigate
            ...
            <a href="<?php echo e(route('inventaires.create')); ?>" wire:navigate
...
<?php /**PATH C:\xampp\htdocs\immos cnam\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>